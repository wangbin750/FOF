...
path = u"C:\\263网盘\\FOF相关程序\\Asset Allocation\\"
out_path = u"E:\\"
#out_path = u"/Users/WangBin-Mac/263网盘/FOF相关程序/Asset Allocation/"
...
weight_frame = pd.DataFrame(index=['stock_huge','stock_large','stock_small','stock_US','stock_HongKong','bond_short','bond_long','gold','money'])

'''
稳健
'''

lam = 0.7 #进取-1.9 平衡-2.0 稳健-2.3
money_weight = 0.75
#money_weight = 1.00

asset_list = ["stock_huge", "stock_large", "stock_small", "stock_US", "stock_HongKong", "bond_short", "bond_long"]
...
asset_list = ["stock_huge", "stock_large", "stock_small", "stock_US", "stock_HongKong", "bond_short", "bond_long", "gold"]
bnds = [(0.0, None), (0.0, None), (0.0, None), (0.0, None), (0.0, None), (0.0, None), (0.0, None), (0.0, None)]
...
if weight_bl['gold'] <= mkt_wgt['gold']:
    ...
    bnds = [(0.0, None), (0.0, None), (0.0, None), (0.0, None), (0.0, None), (0.0, None), (0.0, None), (0.0, mkt_wgt['gold'])]
    weight_bl = Max_Utility_Weight(com_ret, com_cov_mat, lam, bnds)
...
"bond_short" : [u"海富通上证可质押城投债ETF", u"华夏亚债中国指数A", u"易方达7-10年国开行", u"国泰上证5年期国债ETF", u"银华中证中票50指数债券A"],
"bond_long" : [u"国泰上证5年期国债ETF", u"易方达7-10年国开行"],
...
"bond_short" : [u"大成景安短融债券A", u"大成景安短融债券E", u"中金金利A"],
"bond_long" : [u"华安鼎丰债券", u"江信洪福纯债", u"海富通瑞利债券"],
"gold" : [],
"money" : []}
